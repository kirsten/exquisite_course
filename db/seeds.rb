...
broccoli_rabe = Food.create(name: "broccoli rabe", photo: "broccoli-rabe.jpg")
...
chick_peas = Food.create(name: "chickpeas", photo: "chickpeas.jpg")
...
meyer_lemons = Food.create(name: "meyer lemons", photo: "meyer-lemons.jpg")
